...
Suppose we have two experts, who first consider their judgements independently. Expert 1 states $$P(X\le25)=0.25, P(X\le30)=0.5, P(X\le35)=0.75,$$ and
Expert 2 states $$P(X\le30)=0.25, P(X\le35)=0.5, P(X<50)=0.75.$$
